...
import styles from "./IPhone11ProStoryFourth.module.css";

const IPhone11ProStoryFourth = () => {
  ...
  return (
    <div className={styles.iphone11ProStoryfourth}>
      <button
        className={styles.iphone11ProStoryfourthInner}
...
export default IPhone11ProStoryFourth;
