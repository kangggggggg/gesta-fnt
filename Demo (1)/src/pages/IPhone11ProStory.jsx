...
import styles from "./IPhone11ProStory9.module.css";

const IPhone11ProStory9 = () => {
  ...
  return (
    <div className={styles.iphone11ProStory1}>
      <button
        className={styles.iphone11ProStory1Inner}
...
export default IPhone11ProStory9;
