...
import styles from "./IPhone11ProStory2.module.css";

const IPhone11ProStory2 = () => {
  ...
  return (
    <div className={styles.iphone11ProStory2}>
      <button
        className={styles.iphone11ProStory2Inner}
...
export default IPhone11ProStory2;
