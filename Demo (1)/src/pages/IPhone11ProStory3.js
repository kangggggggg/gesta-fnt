...
import styles from "./IPhone11ProStory3.module.css";

const IPhone11ProStory3 = () => {
  ...
  return (
    <div className={styles.iphone11ProStory5}>
      <button
        className={styles.iphone11ProStory5Inner}
...
export default IPhone11ProStory3;
