...
import styles from "./IPhone11ProStory4.module.css";

const IPhone11ProStory4 = () => {
  ...
  return (
    <div className={styles.iphone11ProStory6}>
      <button
        className={styles.iphone11ProStory6Inner}
...
export default IPhone11ProStory4;
